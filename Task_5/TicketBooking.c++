...
public:
    ...
    void hal_name()
    {
        ...
        {
            case 1:
            hall_name="INOX, Salt Lake";
            break;
             case 2:
            hall_name="CINEPOLIS,Lake Mall";
            break;
             case 3:
            hall_name="PVR Cinemas, B.Garden";
            break;
             case 4:
            hall_name="MAIDAN CINEPOLIS, Exide";
            break;
        }
...
void movie_booking::ticket_print()
{
    ...
    char res1;
    cout<<"\n\n\t\t\t\t\t\t\tTo Get Money Receipt PRESS 'y' or 'Y' \n";
    cin>>res1;
    //-------------------------------------------------------------------------------------------------------
        int i,a=0,b=0,d=0;
    char c;
    ...
    for(i=0;i<tkt_pr;i++)
       ...
       cost=cost+cost*(0.18);
        ...
        //------------------------------------------------------------------------
        char res3;
    // cout<<"Enter Y/y to snow resipt : "<<endl;
    cout<<"\n\n\t\t\t\t\t\t\tTo Get Ticket PRESS 'y' or 'Y' \n";
    cin>>res3;
    //-------------------------------------------------------------------------------------------------------------
        cout<<"\n\nPRESS ANY KEY TO CONTINUE\n";
    //    CLEAR();
...
int main()
{
    ...
    while(1)
    {
        cout<<"\n\n\t\t\t\t\t\t\t PRESS 1 TO BOOK TICKET IN : INOX, Salt Lake";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 2 TO BOOK TICKET IN : CINEPOLIS,Lake Mall";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 3 TO BOOK TICKET IN :PVR Cinemas, B.Garden ";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 4 TO BOOK TICKET IN : MAIDAN CINEPOLIS, Exide";
    ...
    switch(obn)
    {
        case 1:
            cout<<"\t\t\t\t\t\t\t";
            cout<<"INOX, Salt Lake IS SELECTED\n";
        obj[0].first();
        break;
        case 2:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"CINEPOLIS,Lake Mall IS SELECTED\n";
        obj[1].first();
        break;
        case 3:
        cout<<"\t\t\t\t\t\t\t";
             cout<<"PVR Cinemas,B.Garden IS SELECTED\n";
        obj[2].first();
        break;
        case 4:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"MAIDAN CINEPOLIS IS SELECTED\n";
        obj[3].first();
        break;
        case 9:
                goto bye;
